        ...
        <c:if test="${empty bookings}">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted">You haven't made any bookings. Browse our vehicles and book your first ride!</p>
                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-md-2">
                                        <img src="${booking.vehicle.imageUrl}" class="img-fluid rounded" alt="${booking.vehicle.make} ${booking.vehicle.model}" style="height: 100px; width: 100%; object-fit: cover;">
                                    </div>
                                    <div class="col-md-3">
                                        <h5 class="mb-1 fw-bold">${booking.vehicle.make} ${booking.vehicle.model}</h5>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <strong>${booking.startDate}</strong> to <strong>${booking.endDate}</strong>
                                        <br>
                                    ...
                                    <div class="col-md-2 text-end">
                                        <c:choose>
                                            <c:when test="${booking.status == 'CONFIRMED'}">
                                                ...
                                                <form action="${pageContext.request.contextPath}/cancelBooking/${booking.id}" method="post" onsubmit="return confirm('Are you sure you want to cancel this booking?');">
