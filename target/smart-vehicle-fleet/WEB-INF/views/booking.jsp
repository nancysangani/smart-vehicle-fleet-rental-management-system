        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card shadow-sm border-0">
                    <img src="${vehicle.imageUrl}" class="card-img-top" alt="${vehicle.make} ${vehicle.model}" style="height: 300px; object-fit: cover;">
                    <div class="card-body">
                        ...
                        <div class="alert alert-light border">
                            <h5 class="mb-0">Daily Rate: <span class="text-primary">$${vehicle.dailyRate}</span></h5>
                        </div>
            ...
            <div class="col-md-6">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-4">
                        ...
                        <form action="${pageContext.request.contextPath}/bookVehicle" method="post" id="bookingForm">
