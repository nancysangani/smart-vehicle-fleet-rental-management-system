            ...
            <c:forEach items="${vehicles}" var="vehicle">
                <div class="col-md-4">
                    <div class="card h-100 shadow-sm border-0 vehicle-card">
                        <img src="${vehicle.imageUrl}" class="card-img-top" alt="${vehicle.make} ${vehicle.model}" style="height: 220px; object-fit: cover;">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-3">
                                <span class="h5 text-primary mb-0">$${vehicle.dailyRate}<small>/day</small></span>
                                <a href="${pageContext.request.contextPath}/vehicle/${vehicle.id}" class="btn btn-primary">
